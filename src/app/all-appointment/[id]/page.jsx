    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 max-w-4xl w-full p-6 md:p-8">
                ...
                {/* Booking btn*/}
                <button className="w-full mt-6 bg-[#1877f2] hover:bg-blue-600 text-white font-semibold py-3.5 px-4 rounded-xl transition duration-200 text-center text-sm md:text-base shadow-sm">
